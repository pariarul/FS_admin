...
const FounderSEO = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`${baseURL}/seo/get-founder-seo`);
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch(`${baseURL}/seo/update-founder-seo`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <div className="flex bg-background min-h-screen">
      ...
      <div className="flex-1 ml-64 p-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-800">Founder - SEO Metadata</h2>
